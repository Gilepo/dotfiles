...
myawesomemenu = {
   ...
   {"Gedit RC", "gedit /home/larry/.config/awesome/rc.lua"},
   {"Gedit zshRC","gedit /home/larry/.zshrc"},
--   {"Nano RC", "gnome-terminal -e 'nano /home/larry/.config/awesome/rc.lua'"},
   { "restart", awesome.restart },
   { "quit", awesome.quit }

}
mycustommenu = {
  		{"Gedit", "gksudo /usr/bin/gedit", "/usr/share/icons/Humanity/apps/16/gedit-icon.xpm"},
                {"Qbit", "/usr/bin/qbittorrent","/usr/share/pixmaps/qbittorrent.xpm"},
                {"Pidgin","/usr/bin/pidgin","/usr/share/pixmaps/pidgin-menu.xpm"}, 
                {"VLC media player","/usr/bin/qvlc","/usr/share/icons/hicolor/32x32/apps/vlc.xpm"},
                {"Nautilus","/usr/bin/nautilus","/usr/share/pixmaps/nautilus.xpm"},
                {"Alsamixer","xterm /usr/bin/alsamixer","/usr/share/app-install/icons/gmerlin-alsamixer.png"},
                {"Pavucontrol","/usr/bin/pavucontrol"},
                {"Synergy", "/usr/bin/synergy"},
                {"KeePass", "keepass2"},
                {"Software Center", "gksudo /usr/bin/software-center"},
                {"Gnome-Disks", "gksudo gnome-disks"}

}
mymainmenu = awful.menu.new({ 
 items = {
 	  {"Awesome", myawesomemenu, beautiful.awesome_icon },
          {"MenuGen", require("menugen").build_menu(), beautiful.awesome_icon },
	  {"Frequent", mycustommenu, "/usr/share/icons/hicolor/16x16/apps/baobab.png"},
	 },
...
globalkeys = awful.util.table.join(
    ...
    --These Mess up the vlc mini skip shortcuts
    ...
    awful.key({ modkey }, "i", function () awful.util.spawn(filebrowser) end),
...
awful.rules.rules = {
    ...
    { rule = { class = "Gnome-terminal" },
          properties = { opacity = 0.99, floating = false, } },
    { rule = { class = "vlc" },
      properties = { floating = true, sticky = true, ontop = true, skip_taskbar = true, tag = tags[1][5], opacity = 1, focusable = nil, skip_focus = true },
  callback = function( c )
                   c:geometry( { x = 940 , y = 510, width = 405, height = 236 } )
               end }, 
    { rule = { class = "Firefox" },
